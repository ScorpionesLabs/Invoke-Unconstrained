...
def main():
    ...
    # Positional Argument
    parser.add_argument("-u", "--user", metavar='USERNAME', help="DOMAIN\\username for authentication, e.g., LAB\DEG$", required=True)
    ...
    parser.add_argument("-aip", "--attacker-ip", metavar='ATTACKERIP', help="Specify a non-exists DNS record that will be point to the attacker-controlled IP Address.")
